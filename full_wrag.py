...
class Full_wrag(real_world_object.Real_world_object, igroc_war.Igroc_war):
    def __init__(self, x, y, w, h, hp, max_hp, stamina, cartinka, nospawn, base_nospawn, point=None, need_point=None,
                 color=[255, 30, 30],
        ...
        real_world_object.Real_world_object.__init__(self, x, y, w, h, cartinka, nospawn, base_nospawn)
